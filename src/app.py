...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice drills and compete against other schools",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "jordan@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Build swimming skills and team relay experience",
    ...
    "Drama Club": {
        "description": "Practice theater skills and prepare for performances",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
